          ...
          <div className="grid gap-0 sm:grid-cols-3 -mx-6">
            <div className="px-6">
              <div className="articleIntro mb-3.5 flex items-center gap-1.5">
                <Image src="/model-stack.svg" alt="Models" 
            ...
            <div className="px-6 border-x border-gray-300">
              <div className="articleIntro mb-3.5 flex items-center gap-1.5">
                <Image src="/GlobeSimple.svg" alt="Community" className="w-8 h-8" width={32} height={32} />
            ...
            <div className="px-6">
              <div className="articleIntro mb-3.5 flex items-center gap-1.5">
                <Image src="/Flag.svg" alt="Community" className="w-8 h-8" width={32} height={32} />
      ...
      <section className="container max-w-3xl px-4 py-8 mx-auto">
        <div className="prose max-w-200 mx-auto">
          ...
          <p className="mb-4 text-gray-700">
            ...
            prototype, and manufacture. Our platform serves as a bridge between designers and
            makers, enabling the sharing of knowledge and creativity that pushes the boundaries
            of what&apos;s possible with 3D printing.
          </p>
          <p className="text-gray-700">
            Whether you&apos;re a hobbyist looking for your next weekend project, an educator
            seeking teaching materials, or a professional designer wanting to share your
            creations, PrintForge provides the tools and community to support your journey in
            3D printing.
          </p>
        </div>
      </section>
